...
public class HelloBmob : MonoBehaviour
{
		...
		void Start ()
		{
            ...
            Bmob.initialize("79623dc152c7ab6d20e97fd900fe0eca", "745f2826456fa0e1c9ee1a65ad9e2768");
...
//        });
		...
		void UpdateGame ()
		{
				...
				game.playerName = "奔雷小肥狸";
                Bmob.Update(TABLENAME, "7cf94c0fd0", game, (resp, exception) =>
				{
						if (exception != null) {
								print ("保存失败, 失败原因为： " + exception.Message);
								return;
